...
public class JpmsUtils {
	...
	/**
	 * The separator of the JPMS argument. For example,
	 * '--add-exports=module/package=other.module'.
	 */
	...
	private static String getAggregatedValue(Set<String> availableModules, JpmsArguments jpmsArgs, JpmsArgType type) {
		...
		for (Iterator<Entry<String, Set<String>>> it = jpmsArgs.getGroupedArgumentsByType(JpmsArgType.ADD_EXPORTS)
