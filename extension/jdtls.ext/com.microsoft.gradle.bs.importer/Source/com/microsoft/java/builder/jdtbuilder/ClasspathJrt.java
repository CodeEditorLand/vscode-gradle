 ...
 *
 * Copied from https://github.com/eclipse-jdt/eclipse.jdt.core/blob/master/org.eclipse.jdt.core/model/org/eclipse/jdt/internal/core/builder/ClasspathJrt.java
 *
 * Contributors:
...
public class ClasspathJrt extends ClasspathLocation implements IMultiModuleEntry {
	...
	static Map<String, SimpleSet> findPackagesInModules(final ClasspathJrt jrt) {
		...
		Map<String, SimpleSet> cache = PackageCache.computeIfAbsent(jrt.zipFilename, zipFileName -> {
			...
			try {
				JRTUtil.walkModuleImage(jrt.jrtFile, new JrtPackageVisitor(packagesInModule),
	...
	public NameEnvironmentAnswer findClass(String binaryFileName, String qualifiedPackageName, String moduleName,
		...
		try {
			...
			IBinaryType reader = ClassFileReader.readFromModule(this.jrtFile, moduleName, qualifiedBinaryFileName,
					moduleNameFilter);
			if (reader != null)
