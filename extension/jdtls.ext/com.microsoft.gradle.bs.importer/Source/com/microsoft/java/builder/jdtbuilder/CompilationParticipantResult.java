 ...
 *
 * Copied from https://github.com/eclipse-jdt/eclipse.jdt.core/blob/master/org.eclipse.jdt.core/model/org/eclipse/jdt/internal/core/builder/CompilationParticipantResult.java
 *
 * Contributors:
 *    IBM - rewrote spec
...
public class CompilationParticipantResult extends BuildContext {
	...
	protected String[] dependencies; // fully-qualified type names of any new dependencies, each name is of the form
										// 'p1.p2.A.B'
	...
	/**
	 * Returns whether the compilation unit contained any annotations when it was
	 * compiled.
	 *
	 * NOTE: This is only valid during
	 * {@link CompilationParticipant#processAnnotations(BuildContext[])}.
	 *
	 * @return whether the compilation unit contained any annotations when it was
	 *         compiled
	 */
	@Override
	...
	/**
	 * Record the fully-qualified type names of any new dependencies, each name is
	 * of the form "p1.p2.A.B".
	 *
	 * @param typeNameDependencies the fully-qualified type names of new
	 *                             dependencies
	 */
	@Override
	 ...
	 * Markers are persisted for these problems only for the declared managed marker
	 * type
