 ...
 *
 * Copied from https://github.com/eclipse-jdt/eclipse.jdt.core/blob/master/org.eclipse.jdt.core/model/org/eclipse/jdt/internal/core/builder/ClasspathMultiDirectory.java
 *
 * Contributors:
...
public class ClasspathMultiDirectory extends ClasspathDirectory {
	...
	public IContainer sourceFolder;
	public char[][] inclusionPatterns; // used by builders when walking source folders
	...
	ClasspathMultiDirectory(IContainer sourceFolder, IContainer binaryFolder, char[][] inclusionPatterns,
		...
		this(sourceFolder, binaryFolder, inclusionPatterns, exclusionPatterns, ignoreOptionalProblems,
