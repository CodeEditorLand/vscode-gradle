 ...
 *
 * Copied from https://github.com/eclipse-jdt/eclipse.jdt.core/blob/master/org.eclipse.jdt.core/model/org/eclipse/jdt/internal/core/builder/ClasspathDirectory.java
 *
 * Contributors:
...
public class ClasspathDirectory extends ClasspathLocation {
	...
	public IContainer binaryFolder; // includes .class files for a single directory
	...
	public char[][] listPackages() {
		...
		try {
			this.binaryFolder.accept(r -> {
				...
				if (r instanceof IFile && extension != null
